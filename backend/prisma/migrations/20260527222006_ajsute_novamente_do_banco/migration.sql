/*
  ...
  - The values [EM_SEPARACAO,FINALIZADO] on the enum `StatusServico` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."StatusServico_new" AS ENUM ('ABERTO', 'INICIADO', 'CONCLUIDO', 'CANCELADO');
